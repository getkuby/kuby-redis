...
Krane::CustomResourceDefinition::ROLLOUT_CONDITIONS_ANNOTATION_SUFFIX = T.let(T.unsafe(nil), String)
...
class Krane::DeployTask
  ...
  def initialize(namespace:, context:, current_sha: T.unsafe(nil), logger: T.unsafe(nil), kubectl_instance: T.unsafe(nil), bindings: T.unsafe(nil), global_timeout: T.unsafe(nil), selector: T.unsafe(nil), filenames: T.unsafe(nil), protected_namespaces: T.unsafe(nil), render_erb: T.unsafe(nil)); end
...
Krane::Deployment::REQUIRED_ROLLOUT_ANNOTATION_DEPRECATED = T.let(T.unsafe(nil), String)
Krane::Deployment::REQUIRED_ROLLOUT_ANNOTATION_SUFFIX = T.let(T.unsafe(nil), String)
...
Krane::EjsonSecretProvisioner::EJSON_SECRET_ANNOTATION = T.let(T.unsafe(nil), String)
...
class Krane::GlobalDeployTask
  ...
  def initialize(context:, global_timeout: T.unsafe(nil), selector: T.unsafe(nil), filenames: T.unsafe(nil), logger: T.unsafe(nil)); end
...
class Krane::KubernetesResource
  ...
  def validate_definition(kubectl, selector: T.unsafe(nil)); end
...
Krane::KubernetesResource::TIMEOUT_OVERRIDE_ANNOTATION_DEPRECATED = T.let(T.unsafe(nil), String)
Krane::KubernetesResource::TIMEOUT_OVERRIDE_ANNOTATION_SUFFIX = T.let(T.unsafe(nil), String)
...
class Krane::RestartTask
  def initialize(context:, namespace:, logger: T.unsafe(nil), global_timeout: T.unsafe(nil)); end

  def perform(**args); end
  def perform!(deployments: T.unsafe(nil), selector: T.unsafe(nil), verify_result: T.unsafe(nil)); end
  def run(**args); end
  def run!(deployments: T.unsafe(nil), selector: T.unsafe(nil), verify_result: T.unsafe(nil)); end
  ...
  def identify_target_deployments(deployment_names, selector: T.unsafe(nil)); end
  def kubeclient; end
  def kubeclient_builder; end
  def kubectl; end
...
class Krane::RunnerTask
  def initialize(namespace:, context:, logger: T.unsafe(nil), global_timeout: T.unsafe(nil)); end
...
class Krane::TaskConfig
  def initialize(context, namespace, logger = T.unsafe(nil)); end
