      ...
      module Databases
        module V1
          class RedisFailoverSpecRedisAffinityPodAntiAffinityPreferredDuringSchedulingIgnoredDuringExecutionPodAffinityTermNamespaceSelectorMatchExpressions < ::KubeDSL::DSLObject
            ...
            def kind_sym
              :redis_failover_spec_redis_affinity_pod_anti_affinity_preferred_during_scheduling_ignored_during_execution_pod_affinity_term_namespace_selector_match_expressions
            end
          end
        end
      end
