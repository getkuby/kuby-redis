      ...
      module Databases
        module V1
          class RedisFailoverSpecRedisAffinityPodAffinityPreferredDuringSchedulingIgnoredDuringExecutionPodAffinityTermLabelSelectorMatchExpressions < ::KubeDSL::DSLObject
            ...
            def kind_sym
              :redis_failover_spec_redis_affinity_pod_affinity_preferred_during_scheduling_ignored_during_execution_pod_affinity_term_label_selector_match_expressions
            end
          end
        end
      end
